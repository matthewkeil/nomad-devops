...
/******/ 	return __webpack_require__(__webpack_require__.s = "./lib/api/githubAuthUri.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.handler = void 0;\n\nvar simple_oauth2_1 = __webpack_require__(/*! simple-oauth2 */ \"./node_modules/simple-oauth2/index.js\");\n\nvar randomstring_1 = __webpack_require__(/*! randomstring */ \"./node_modules/randomstring/index.js\");\n\nexports.handler = function (_, __, callback) {\n  try {\n    var oauth2 = simple_oauth2_1.create({\n      client: {\n        id: process.env.OAUTH_CLIENT_ID,\n        secret: process.env.OAUTH_CLIENT_SECRET\n      },\n      auth: {\n        tokenHost: \"https://github.com\",\n        tokenPath: \"/login/oauth/access_token\",\n        authorizePath: \"/login/oauth/authorize\"\n      }\n    });\n    var originPattern = process.env.OAUTH_ORIGIN || \"\";\n\n    if (originPattern === \"\") {\n      throw new Error(\"Will not run without a safe ORIGIN pattern in production.\");\n    } // Authorization uri definition\n\n\n    var Location = oauth2.authorizationCode.authorizeURL({\n      // eslint-disable-next-line @typescript-eslint/camelcase\n      redirect_uri: process.env.REDIRECT_URL,\n      scope: \"repo,user\",\n      state: randomstring_1.generate(32)\n    });\n    callback(null, {\n      statusCode: 302,\n      headers: {\n        Location: Location\n      }\n    });\n  } catch (err) {\n    callback(err);\n  }\n};\n\n//# sourceURL=webpack:///./lib/api/githubAuthUri.ts?");
